...
docker tag rmd-tidyverse:latest localhost:5000/rmd-tidyverse
docker push localhost:5000/rmd-tidyverse
...
Namespace:
From: rmd-tidyverse:latest
EOI
# build singularity image
sudo SINGULARITY_NOHTTPS=1 singularity build singularity/rmd-tidyverse.sif "$TMPFILE"
